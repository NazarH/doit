      ...
      <div class='container'>
        ...
        <div class='game-info'>
            ...
            <div>
               <div @click='tournCheck1' class='tournCheck'>
                  <img src='../assets/check2.png' id='tournCheck'>
               </div> 
        ...
        <div class='registration'>
            <div class='basic'>
                ...
                <div>
                    <div @click='tournCheck2' class='tournCheck'>
                        <img src='../assets/check2.png' id='tournCheck2'>
                    </div> 
            ...
            <div>
               ...
               <div>
                  <div @click='regAct1' id='r1' class='someReg'>Free</div>
                  <div @click='regAct2' id='r2' class='someReg'>Paid</div>
                  <div @click='regAct3' id='r3' class='someReg'>PRERMIUM</div>
                  <div @click='regAct4' id='r4' class='someReg'>PRIVATE</div>
               </div>
            </div>
            <div>
            ...
            <div>
                <div @click='tournCheck3' class='tournCheck'>
                    <img src='../assets/check2.png' id='tournCheck3'>
                </div>
        ...
        <div class='player-list'>
           ...
           <div>
              <div @click='tournCheck4' class='tournCheck'>
                   <img src='../assets/check2.png' id='tournCheck4'>
              </div> 
        ...
        <div class='leagues'>
           ...
           <div>
              <div @click='tournCheck5' class='tournCheck'>
                   <img src='../assets/check2.png' id='tournCheck5'>
              </div>  
        ...
        <div class='prize-pool'>
            ...
            <div>
              <div @click='tournCheck26' class='tournCheck'>
                <img src='../assets/check2.png' id='tournCheck26'>
              </div>  
                ...
                <div>
                   ...
                   <div>
                     <div @click='tournCheck14' class='tournCheck'>
                        <img src='../assets/check2.png' id='tournCheck14'>
                     </div> 
                      <div>europe nordic & east</div>
                   </div>
                   <div>
                     <div @click='tournCheck15' class='tournCheck'>
                        <img src='../assets/check2.png' id='tournCheck15'>
                     </div> 
                      <div>Europe West</div>
                   </div>
                   <div>
                     <div @click='tournCheck16' class='tournCheck'>
                        <img src='../assets/check2.png' id='tournCheck16'>
                     </div> 
                      <div>Australia & Oceania</div>
                   </div>
                   <div>
                     <div @click='tournCheck17' class='tournCheck'>
                        <img src='../assets/check2.png' id='tournCheck17'>
                     </div> 
                      <div>china</div>
                   </div>
                   <div>
                     <div @click='tournCheck18' class='tournCheck'>
                        <img src='../assets/check2.png' id='tournCheck18'>
                     </div> 
                      <div>Asia</div>
                   </div>
                   <div>
                     <div @click='tournCheck19' class='tournCheck'>
                        <img src='../assets/check2.png' id='tournCheck19'>
                     </div> 
                      <div>Amercia</div>
                   </div>
                </div>
                <div>
                   ...
                   <div>
                     <div @click='tournCheck20' class='tournCheck'>
                        <img src='../assets/check2.png' id='tournCheck20'>
                     </div> 
                      <div>PC</div>
                   </div>
                   <div>
                     <div @click='tournCheck21' class='tournCheck'>
                        <img src='../assets/check2.png' id='tournCheck21'>
                     </div> 
                      <div>Xbox one</div>
                   </div>
                   <div>
                     <div @click='tournCheck22' class='tournCheck'>
                        <img src='../assets/check2.png' id='tournCheck22'>
                     </div> 
                      <div>ps4</div>
                   </div>
                   <div>
                     <div @click='tournCheck23' class='tournCheck'>
                        <img src='../assets/check2.png' id='tournCheck23'>
                     </div> 
                      <div>nintendo switch</div>
                   </div>
                   <div>
                     <div @click='tournCheck24' class='tournCheck'>
                        <img src='../assets/check2.png' id='tournCheck24'>
                     </div> 
                      <div>PS5</div>
                   </div>
                   <div>
                     <div @click='tournCheck25' class='tournCheck'>
                        <img src='../assets/check2.png' id='tournCheck25'>
                     </div> 
        ...
        <div class='sponsors'>
            ...
            <div v-for='(sponsor, index) in tournament.tournSponsors' :key='sponsor.id'>
                ...
                <div>
                    <input type='text' placeholder='banner url' :id='"tempsURL" + index' disabled>
                ...
                <img src='' :id='"imgSpons" + index' style='display: none' class='img'>
            </div>
            <div>
        ...
        <div class='three-buttons'>
           <button @click='saveTournament'>Save Tournamnet</button>
        </div>
      </div>
   </div>
</template>
   ...
   data(){
       return{
           ...
           tournament: {
               ...
               tourn3ST: '',
               tourn4ST: '',
               tournTypeMoney: false,
               tournTypeThing: false,
               tournTypeMPT: false,
               tournTypeNothing: false,
               tournTypeQualifers: false,
               tournRO8: '',
               tournRO16: '',
               tournRO32: '',
               tournRO64: '',
               ...
               tournVotingOne: false,
               tournVotingTwo: false,
               ...
               tournMode2: '',
               tournVeto: '',
               tournEuropeNord: false,
               tournEuropeWest: false,
               tournAustralia: false,
               tournChina: false,
               tournAsia: false,
               tournAmerica: false,
               tournPC: false,
               ...
               tournPS5: false,
               tournSeriesX: false,
               tournDiscord: 'https://discord.com/',
               tournFacebook: 'https://www.facebook.com/groups/',
               tournTwitt: 'https://twitter.com/',
               tournVK: 'https://vk.com/',
               tournTwitch: 'https://www.twitch.tv/',
               tournYouTube: 'https://www.youtube.com/channel/',
               tournRegion: '',
               tournPlatform: '',
